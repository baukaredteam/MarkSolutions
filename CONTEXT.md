...
- **06.08 — T0 (стек) и T0-web (каркас веб-морды) закрыты.** Веб-морда: Vite+React+TS, 4 страницы (/apply, /status, /login, /products), api-client с форматом Приложения B, фикстура инвойса = 38 реальных строк Nomad + 2 demo (ADR-019).
